...
public final class Erina extends World {
	 ...
	 * have been restricted. It is important to prevent Competitors from gaining access to
	 * instances of super types (such as Actor, World), as such instances would enable the
	 * Competitors to call illegal methods. It is also important to override (or in some
	 * other way limit) any additional methods that may be added to Greenfoot in future
	 * Greenfoot releases.
	 *
	 *
	 ...
	 *
	 * Competitors no longer extend Actors, instead the super class contain a private
	 * Actor field inaccessible to subclasses.
	 *
	 *
